...
<template>
  <div id="data-list">
    ...
    >
      ...
      <!-- {{company.id}} -->
        <vs-button :disabled="category == null || company == null || department_name == null" type="filled" @click="addDepartment()" class="mb-2"
          >SUBMIT</vs-button
        >
      </form>
    </vx-card>
...
export default {
  ...
  methods: {
    addDepartment() {
      ...
      axios
        .post(`${process.env.VUE_APP_BASE_URI}/dashboard/department/` , formData)
        .then(response => {
