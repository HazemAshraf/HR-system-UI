    ...
    >
      <form>
        <div class="vx-row">
          ...
          <div class="vx-col md:w-1/4 sm:w-1/2 w-full">
            <vs-button type="filled" @click.prevent="addNewUser" class=" mb-2"
              >Filters</vs-button
            >
          </div>
        </div>
  ...
  data() {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: "Phisical Working Hs",
          field: "phisicalWorkingHs",
          width: 150
        },
        {
          headerName: "Over Time per min",
          field: "overTimePerMin",
          width: 150
        },
        {
          headerName: "Latency per min",
          field: "latencyPerMin",
          width: 150
        }
      ],
    ...
    addNewUser() {
      ...
      this.$validator.validateAll().then(result => {
        if (result) {
          ...
          this.$store.dispatch(
            "hrReportManagement/fetchItemsTimeAttendance",
